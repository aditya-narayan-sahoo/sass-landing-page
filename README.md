...
```
git clone https://github.com/aditya-narayan-sahoo/sass-landing-page.git
...
- This website was done with the help of this youtube video : [Video](https://youtu.be/ukiGFmZ32YA?si=nG6yA0lLtiCPEbfN)
- Checkout his channel for more such videos : [Javascript Mastery](https://www.youtube.com/@javascriptmastery)
